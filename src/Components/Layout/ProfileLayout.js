        ...
        <div>
           ...
           <Ref innerRef={ContextRef}>
               ...
               <Grid columns='3'>
                   ...
                   <Grid.Column  mobile={16} tablet={4} computer={11}>
                      <Visibility context={ContextRef} ><div style={{marginTop:"20px"}}></div><Profile></Profile></Visibility>
                   </Grid.Column>
           ...
           <Media between={["tablet", "computer"]}>
              ...
              <Media between={["zero", "mobile"]}>
                ...
                <Grid>
                  <Grid.Column>  <Visibility context={ContextRef} ><div style={{marginTop:"20px"}}></div><Profile></Profile></Visibility></Grid.Column>
                </Grid>
              </Media>
